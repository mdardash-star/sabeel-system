...
function isPersistentRoute(method, pathname) {
  if (method === 'GET') {
    return pathname === '/api/v1/users' || pathname === '/api/v1/users/roles' ||
      ...
      ['/api/v1/marketing/stats','/api/v1/marketing/segments','/api/v1/marketing/campaigns','/api/v1/marketing/audience-preview','/api/v1/marketing/channels/status','/api/v1/marketing/store/products','/api/v1/marketing/store/intelligence','/api/v1/marketing/store/orders','/api/v1/marketing/store/customers','/api/v1/marketing/store/content-ideas'].includes(pathname) ||
