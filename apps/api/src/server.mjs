...
function isPersistentRoute(method, pathname) {
  if (method === 'GET') {
    return pathname === '/api/v1/users' || pathname === '/api/v1/users/roles' ||
      ...
      ['/api/v1/marketing/attribution','/api/v1/marketing/content-attribution','/api/v1/marketing/revenue-intelligence','/api/v1/marketing/executive-brief-live','/api/v1/marketing/autopilot/history','/api/v1/marketing/autopilot/effectiveness','/api/v1/marketing/customer-360','/api/v1/marketing/next-best-action/effectiveness','/api/v1/marketing/retention-journeys','/api/v1/marketing/retention/effectiveness','/api/v1/marketing/revenue-forecast','/api/v1/marketing/profit-intelligence','/api/v1/marketing/profit-decisions','/api/v1/marketing/profit-actions/effectiveness','/api/v1/marketing/channel-profitability','/api/v1/marketing/channel-decisions','/api/v1/marketing/channel-decisions/effectiveness','/api/v1/marketing/bundle-profitability','/api/v1/marketing/bundle-actions/effectiveness','/api/v1/marketing/store/backfill-status','/api/v1/marketing/integration-health','/api/v1/marketing/operational-readiness','/api/v1/marketing/attribution-coverage','/api/v1/marketing/attribution-repair-queue','/api/v1/marketing/attribution-repair/effectiveness','/api/v1/marketing/executive-growth-priorities','/api/v1/marketing/growth-priority-drafts','/api/v1/marketing/profit-data-coverage','/api/v1/marketing/cost-repair-queue','/api/v1/marketing/data-readiness-summary','/api/v1/marketing/self-test'].includes(pathname) ||
