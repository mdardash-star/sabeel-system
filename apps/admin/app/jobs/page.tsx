...
export default function JobsPage(){
  ...
  return <PreviewAuthGuard><main className="customers-page jobs-page"><header className="customers-top"><a className="customers-brand" href="/"><span>S</span><strong>سبيل</strong><small>نظام التشغيل</small></a><nav className="section-nav" aria-label="تنقل الأقسام"><a href="/">لوحة التحكم</a><a className="active" href="/jobs">المهام</a><a href="/customers">العملاء</a><a href="/technicians">الفنيون</a><a href="/maintenance">الصيانة</a><a href="/finance">المالية</a></nav><div className="profile-avatar">م</div></header><div className="customers-wrap">
